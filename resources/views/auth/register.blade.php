    ...
    <div class="flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                <h1 class="text-3xl font-semibold mb-2 text-black text-center">Register</h1>
                <h1 class="text-sm font-semibold mb-5 text-gray-500 text-center">Mari Mulai Perjalanan Kariermu Bersama Kami!</h1>
                <form action="{{ route('register.makeaccount') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
                    ...
                    <div>
                        <button type="submit"
                            class="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Register</button>
                    </div>
                </form>
                <div class="mt-5 text-center font-semibold text-gray-500 text-sm">
                    <p>Sudah Mempunyai Akun? Silahkan <a class="underline" href="{{ route('login.index') }}">Login</a></p>
                </div>
            </div>
        </div>
    </div>
